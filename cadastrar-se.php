...
<body>
  <div id="preloder">
                    ...
                    <div class="hero__tab">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="hero__tab__form">
                                    ...
                                    <form method="POST" id="formCliente" enctype="multipart/form-data">
                                        ...
                                        <a href="sem login.php"><button type="button" class="site-btn" style="margin-top: 10px">Voltar</button></a>
                                        <button type="submit" class="site-btn" value="AddU" name="acao">Cadastrar</button>
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="hero__tab__form">
                                    <h4 style="margin-bottom: 10px; font-weight: bold;">Cadastrar-se como Administrador:</h4>
                                    <form id="formAdmin" method="POST" enctype="multipart/form-data">
                                      ...
                                      <div class="input-group mb-3">
                                          ...
                                          <input type="text" class="form-control" required placeholder="Digite seu nome" name="nome_corretor">
                                      </div>
                                      ...
                                      <div class="input-group mb-3">
                                          ...
                                          <input type="text" class="form-control cpf_corretor" required placeholder="xxx.xxx.xxx-xx" name="cpf_corretor" id="cpf_corretor" autocomplete="off" maxlength="14">
                                      </div>
                                      <div class='alert alert-danger mt-3' role='alert' id='alerta_cpf_corretor'>
                                      ...
                                      <div class="input-group mb-3">
                                          <div class="input-group-prepend">
                                              <span class="input-group-text" id="basic-addon1">Número da Matrícula:</span>
                                          </div>
                                          <input type="text" class="form-control" required placeholder="Digite sua matrícula" name="n_matricula">
                                      </div>

                                      <div class="input-group mb-3">
                                          <div class="input-group-prepend">
                                              <span class="input-group-text" id="basic-addon1">Data de Admissão:</span>
                                          </div>
                                      ...
                                      <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control telefone_corretor" required placeholder="Digite seu telefone" name="telefone" maxlength="14">
                                        </div>
                                      <div class='alert alert-danger mt-3' role='alert' id='alerta_telefone_corretor'>
                                      ...
                                      <div class="input-group mb-3">
                                          ...
                                          <div class="custom-file">
                                              <input type="file" class="custom-file-input" required id="inputGroupFileB" name="foto">
                                              <label class="custom-file-label" for="inputGroupFileB">Escolha uma foto</label>
                                          </div> 
                                      </div>  

                                      <a href="sem login.php"><button type="button" class="site-btn" style="margin-top: 10px">Voltar</button></a>
                                      <button type="submit" class="site-btn" style="margin-top: 10px" value="AddA" name="acao">Cadastrar</button>
                                  </form>
    ...
    $(document).ready(function() {
        ...
        $('.cpf_corretor').mask('000.000.000-00');
        $('.telefone_corretor').mask('(00)00000-0000');

        // Hide alert messages initially
        $('.alerta_cliente, .alerta_conjuge, .alerta_telefone, #alerta_cpf_corretor, #alerta_telefone_corretor').hide();

        // Form submission event for Cliente
        ...
        // Form submission event for Admin/Corretor
        $('#formAdmin').on('submit', function(event) {
            let cpfCorretor = $('.cpf_corretor').val().replace(/\D/g, '');
            let telefoneCorretor = $('.telefone_corretor').val().replace(/\D/g, '');

            // Validate CPF Corretor
            if (cpfCorretor.length !== 11) {
                event.preventDefault();
                $('#alerta_cpf_corretor').show();
                setTimeout(() => {
                    $('#alerta_cpf_corretor').fadeOut();
                }, 3000);
            }

            // Validate Telefone Corretor
            if (telefoneCorretor.length !== 11) {
                event.preventDefault();
                $('#alerta_telefone_corretor').show();
                setTimeout(() => {
                    $('#alerta_telefone_corretor').fadeOut();
                }, 3000);
            }
        });
    });
